...
preferred_names <- read_excel("../01_raw-data/formatted-names-GMH-v2.xlsx")
...
### Replace stebs database names with preferred names
...
stebs_wrangled_updated <- stebs_wrangled %>%
  ...
  left_join(., unique_stebs_with_preferred, by = join_by(verbatim_name == database_name)) %>%
  # put them in order
